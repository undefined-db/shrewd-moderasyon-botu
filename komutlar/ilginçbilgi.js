...
exports.run = function (client, message) {
    ...
    var ilginçbilgi = [
        ...
        "Bu Altyapıyı **Shréwd** Yaptı Biliyomuydun :)",
     ...
     var ilginçbilgi = ilginçbilgi[Math.floor(Math.random()*ilginçbilgi.length)];


      const embed = new Discord.MessageEmbed()
       .setAuthor("İlginç Bilgi!", message.author.avatarURL())
       .setColor("RANDOM")
       .setFooter(`${message.author.username} Yeni Bilgi Öğrendi!`)
       .setDescription(`${ilginçbilgi}`)
